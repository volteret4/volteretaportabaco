...
```shell
git clone https://github.com/volteret4/volteretaportabaco
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/volteretaportabaco/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://volteret4.github.io/volteretaportabaco'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/volteret4/volteretaportabaco
  - link: https://github.com/volteret4/volteretaportabaco#readme
...
`https://volteret4.github.io/volteretaportabaco`